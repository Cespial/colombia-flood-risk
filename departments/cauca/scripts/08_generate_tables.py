...
=====================
Generate publication-quality tables as CSV and LaTeX for the Cauca
...
def generate_table5_municipal_risk() -> pd.DataFrame:
    ...
    _save_latex_styled(
        ...
        caption="Top 20 municipalities in Cauca ranked by composite flood risk score. "
...
def generate_table6_population_exposure() -> pd.DataFrame:
    ...
    total_row = {"Subregion": "TOTAL (Cauca)"}
    ...
    _save_latex_styled(
        ...
        caption="Population exposure to flood risk by subregion in Cauca. "
...
def generate_table7_seasonal_dynamics() -> pd.DataFrame:
    ...
    showing the bimodal precipitation/flood pattern in Cauca.
    """
    ...
    _save_latex_styled(
        ...
        caption="Monthly flood extent statistics for Cauca (2015--2025). "
...
def main() -> None:
    ...
    logger.info("=" * 70)
    logger.info("TABLE GENERATION - CAUCA FLOOD RISK ASSESSMENT")
    logger.info("=" * 70)
