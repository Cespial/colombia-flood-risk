...
========================================
Nature-quality figures for Cauca flood risk manuscript.
...
def load_boundary():
    return gpd.read_file(BOUNDARIES_DIR / "cauca_department_boundary_GADM41.geojson")
...
def fig01_study_area():
    ...
    cauca_p = cauca.to_crs(CRS_COLOMBIA)
    ...
    if has_colombia:
        ...
        cauca_p.plot(ax=ax, color='#d4a574', edgecolor='#333333', linewidth=0.5)
    else:
        cauca_p.plot(ax=ax, color='#d4a574', edgecolor='#333333', linewidth=0.5)
    ...
    cauca_p.boundary.plot(ax=ax, color='#333333', linewidth=0.6)
...
def fig02_sar_water_detection():
    ...
    for ax, img, label, title in panels:
        ...
        cauca.boundary.plot(ax=ax, color='#444444', linewidth=0.3)
