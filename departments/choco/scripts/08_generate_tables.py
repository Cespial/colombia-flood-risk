...
=====================
Generate publication-quality tables as CSV and LaTeX for the choco
...
def generate_table5_municipal_risk() -> pd.DataFrame:
    ...
    _save_latex_styled(
        ...
        caption="Top 20 municipalities in choco ranked by composite flood risk score. "
...
def generate_table6_population_exposure() -> pd.DataFrame:
    ...
    total_row = {"Subregion": "TOTAL (choco)"}
    ...
    _save_latex_styled(
        ...
        caption="Population exposure to flood risk by subregion in choco. "
...
def generate_table7_seasonal_dynamics() -> pd.DataFrame:
    ...
    showing the bimodal precipitation/flood pattern in choco.
    """
    ...
    _save_latex_styled(
        ...
        caption="Monthly flood extent statistics for choco (2015--2025). "
...
def main() -> None:
    ...
    logger.info("=" * 70)
    logger.info("TABLE GENERATION - choco FLOOD RISK ASSESSMENT")
    logger.info("=" * 70)
